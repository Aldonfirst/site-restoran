    ...
    <div className='navbar'>
      <Link to={'/'}>
        ...
        <ul className="navbar-menu">
          ...
          <a href='#app-download' onClick={()=>setMenu("mobile-app")} className={menu==="mobile-app"?"active":""}>Скачайте приложение</a>
          <a href='#footer' onClick={()=>setMenu("contact-us")} className={menu==="contact-us"?"active":""}>О нас</a>
        </ul>
